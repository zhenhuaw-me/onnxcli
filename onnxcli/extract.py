...
class ExtractCmd(SubCmd):
    ...
    def add_args(self, subparser):
        ...
        subparser.add_argument('-i', '--input_names', nargs="+", help="The names of the input tensors that to be extracted.")
        subparser.add_argument('-o', '--output_names', nargs="+", help="The names of the output tensors that to be extracted.")

    def run(self, args):
        print("Running <Model Extraction> on model {}".format(args.input_path))
        import onnx
